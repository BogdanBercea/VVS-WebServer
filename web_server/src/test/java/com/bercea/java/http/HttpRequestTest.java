...
public class HttpRequestTest {
	...
	@Test
	public void unknownRequest_WHAT() throws IOException {
		HttpRequest req = new HttpRequest(new ByteArrayInputStream("WHAT / HTTP/1.1\n\n".getBytes()));
		Assert.assertEquals(Method.UNRECOGNIZED, req.method);
	}

	@Test
	public void unknownRequest_WHO() throws IOException {
		HttpRequest req = new HttpRequest(new ByteArrayInputStream("WHO / HTTP/1.1\n\n".getBytes()));
		Assert.assertEquals(Method.UNRECOGNIZED, req.method);
	}
}
